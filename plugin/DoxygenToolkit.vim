...
" DoxygenHeadFunc
""""""""""""""""""""""""""
function! <SID>DoxygenHeadFunc()
  let s:macro = "_".toupper(expand("%:t:r"))."_H_"

  if expand("%:e") == 'hpp' || expand("%:e") == 'h'
    exec "normal O"."#ifndef ".s:macro." //auto generated by vim script"
    exec "normal o"."#define ".s:macro
    exec "normal o"
    
    ""cplusplus export
    if expand("%:e") == 'hpp' && g:DoxygenToolkit_cplus == 1
      exec "normal o"."#ifdef __cplusplus"
      exec "normal o"."extern \"C\""
      exec "normal o"."{"
      exec "normal o"."#endif //"."__cplusplus\<enter>"
    endif
...
command! -nargs=0 DoxHead :call <SID>DoxygenHeadFunc()
...
map --dh :call <SID>DoxygenHeadFunc()<CR>
